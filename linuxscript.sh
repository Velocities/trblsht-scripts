...
echo -e 'PLEASE NOTE: This script uses the ping command to test the TCP/IP layer and network connections. If your network or device firewall blocks pings, the results of this script will not be relevant. \n'
